...
var Window = React.createClass({
	...
	render: function render() {
		var max;
		if (this.state.fullscreen) max = React.createElement('div', { className: 'window-btn', id: 'window-max-off', onClick: this.handleClick });else max = React.createElement('div', { className: 'window-btn', id: 'window-max', onClick: this.handleClick });
...
var Compare = React.createClass({
	...
	getInitialState: function getInitialState() {
		return {
			project: decodeURI(location.href.split('?')[1])
		};
	},
	render: function render() {
		return React.createElement(
			'div',
			null,
			React.createElement(Header, { project: this.state.project })
		);
	}
});

// const Indegs = React.createClass({
// 	getInitialState:function(){
// 		return ({
// 			projects:ProjectStore.getProject(),
// 			route:ProjectStore.getRoute()
// 		})
// 	},
// 	handleResize:function(){
// 		$('body').css('height',window.outerHeight);
// 		$('#images').css('height',$('body').innerHeight()-$('#top').outerHeight())
// 	},
// 	componentDidMount:function(){
// 		$('body').css('height',window.outerHeight);
// 		window.addEventListener('resize',this.handleResize);
...
// 		return (
// 		<div id="indegs">
// 			<Header route={this.state.route} projects={this.state.projects} />
// 			{route}
// 		</div>
// 		)
// 	}
...
React.render(React.createElement(Compare, null), document.body);
